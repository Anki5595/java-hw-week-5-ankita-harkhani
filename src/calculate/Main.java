...
public class Main {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in); // scanner declaration to read a data
        char continueCalculation = 'Y';
        while (continueCalculation == 'Y' || continueCalculation == 'y') { // While loop for continuous calculation
            ...
            Calculator obj = new Calculator(); // calling method from another class
